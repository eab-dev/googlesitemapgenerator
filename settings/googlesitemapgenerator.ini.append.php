...
[PathSettings]
EZPublishDirectory=ezpublish-4.2.0
# If you want to create static sitemaps via cronjob set the file + path (below your ez installation root) here
# Remember to create the directory you use (for instance the sitemap/ dir)
StaticSitemapFile=/usr/local/zend/apache2/htdocs/ezpublish-4.2.0/google_sitemap.xml
...
# Google recommends to list only news not older than 2 days
# set StartDate to  2 on production environment (default for testing is 90 days)
StartDate=
NewsLimit=5000
*/ ?>
